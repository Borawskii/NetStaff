...
public class Mongo {
    ...
    private final String DATABASE_NAME = "THC-Netcore";
    ...
    public Mongo() {
        ...
        credentialList.add(MongoCredential.createMongoCRCredential("THC-Netcore", DATABASE_NAME, "q5mEM7EmVSUFTGvq".toCharArray()));
